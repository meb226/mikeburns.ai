/**
 * Active Pursuit - Frontend JavaScript
 */
...
const firmHint = document.getElementById('firmHint');
...
function handleFirmSelect(e) {
  ...
  if (firm) {
    const topIssues = firm.topIssues?.join(', ') || 'Various';
    firmHint.textContent = `${firm.coveredOfficialCount || 0} covered officials • ${firm.totalClients || 0} clients • Top issues: ${topIssues}`;
  } else {
    firmHint.textContent = '';
  }
}
